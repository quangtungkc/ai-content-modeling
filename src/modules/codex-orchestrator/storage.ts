...
export function ensureCodexStorage() {
  if (!ready) ready = (async () => {
    const statements = [
      ...
      `CREATE INDEX IF NOT EXISTS "RuntimeFailure_status_createdAt_idx" ON "RuntimeFailure"("status", "createdAt")`,
      `CREATE INDEX IF NOT EXISTS "RuntimeFailure_userId_createdAt_idx" ON "RuntimeFailure"("userId", "createdAt")`,
