/**
 * Shared modeling instruction. This is deliberately a prompt-time policy:
 * Gemini must screen the source before it writes any production prompt.
 */
export const MODELING_SAFETY_POLICY = `
