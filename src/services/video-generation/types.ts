...
export type VeoPromptInput = { sceneId: string; scene: Record<string, unknown>; characterData: Record<string, unknown>; assetReferences: ReferenceImage[]; background: Record<string, unknown>; camera: Record<string, unknown>; action: Record<string, unknown>; audio: Record<string, unknown>; duration: 4 | 6 | 8; constraints: string[]; sourceModelingConstraints?: string; aspectRatio?: "16:9" | "9:16"; resolution?: "720p" | "1080p" | "4k"; firstFrame?: VideoFrame; lastFrame?: VideoFrame; audioEnabled?: boolean };
export type VeoRequest = { sceneId: string; prompt: string; promptFidelity?: { promptId: string; promptHash: string }; referenceImages?: ReferenceImage[]; aspectRatio: "16:9" | "9:16"; resolution: "720p" | "1080p" | "4k"; duration: 4 | 6 | 8; firstFrame?: VideoFrame; lastFrame?: VideoFrame; audioEnabled?: boolean };
