...
const modelingDirectionSchema = z.object({ title: z.string(), coreConcept: z.string(), sourceMechanism: z.string(), whatIsPreserved: z.array(z.string()), whatIsChanged: z.array(z.string()), targetMarketAdaptation: z.string(), similarityRisk: z.enum(["low", "medium", "high"]), whyWorthDeveloping: z.string() });
export const modelingIdeasSchema = z.object({ schemaVersion: z.literal("1.0"), modelingDirections: z.array(modelingDirectionSchema).min(3).max(5) });
