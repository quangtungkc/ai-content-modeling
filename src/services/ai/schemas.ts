...
export const developedIdeaSchema = z.object({ schemaVersion: z.literal("1.0"), deconstruction: z.record(z.string(), z.unknown()), artDirection: z.record(z.string(), z.unknown()), characterDesign: z.record(z.string(), z.unknown()), backgroundDesign: z.record(z.string(), z.unknown()), storyboard: z.array(z.object({ sceneNumber: z.number().int().positive(), visualBlock: z.string(), actionBlock: z.string(), audioBlock: z.string(), startFramePrompt: z.string(), englishPrompt: z.string() })), safetyReview: z.record(z.string(), z.unknown()) });
