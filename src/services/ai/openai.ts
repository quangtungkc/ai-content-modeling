...
export class OpenAIProvider implements AIProvider {
  ...
  private async request<T>(instruction: string, input: unknown, schema: z.ZodType<T>, includeMainCharacterImage = true, strictSchema = true): Promise<T> {
