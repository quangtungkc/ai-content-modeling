...
const developedIdeaResponseSchema: Record<string, unknown> = {
  ...
  properties: {
    ...
    safetyReview: { type: "object", additionalProperties: false, properties: { description: { type: "string" }, safetyStatus: { type: "string", enum: ["PASS", "BLOCKED"] }, blockedReasons: { type: "array", items: { type: "string" } }, safeAlternative: { type: "string" } }, required: ["description", "safetyStatus", "blockedReasons", "safeAlternative"] },
  },
